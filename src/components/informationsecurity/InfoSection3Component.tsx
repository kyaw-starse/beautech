          ...
          <table className="w-full table-fixed border-collapse border-t-2 border-l-2 border-gray-200">
            <tbody>
              {[
                ...
                [
                  "コスメディア会員の方の個人情報",
                  "会員の本サービスの運用・管理、ご購入商品の発送、ご請求、クレジットカードの不正利用検知・防止のためのご利用カード会社への提供、サービスに関する情報のお知らせ、各種連絡のため",
                  "対象",
                ],
                [
                  "出店している外部ECサイトからご注文いただいた方の個人情報",
      ...
      <div className="bg-[#dce5ea]">
        <div className="container py-10 md:py-20">
          ...
          <ul className="list-decimal list-inside leading-loose marker:font-bold">
            ...
            <li className="mb-5 pl-5 -indent-5 space-y-4">
              ...
              <p className="leading-loose pl-6 -indent-6">
                ...
                <br />
                外国において個人データを取り扱う場合は、当該外国における個人情報の保護に関する制度等を把握した上で安全管理措置を実施します。
                <br />
                ※当社は、商品ご購入時にお客様が利用されているクレジットカード発行会社を除き、外国において個人データを取り扱うことはありません。
              </p>
            </li>
            <li className="mb-0 pl-5 -indent-5">
              個人情報の第三者提供について
              <br />
              当社は、ご本人の同意を得た場合以外、個人情報を第三者に提供いたしません。ただし、人の生命、身体または財産の保護のために必要な場合であって、ご本人様の同意をいただくことが困難な場合、その他法令に基づき開示、提供を要請される場合はこの限りではありません。
              <br />
              当社は法的な定めの他、カード発行会社が行う不正利用防止のために、商品ご購入時にお客様が利用されているカード発行会社へ、当社がお客様から収集した以下の個人情報等を提供させていただきます。
              <br />
              ◆提供する項目：氏名、電話番号、emailアドレス、インターネット利用環境に関する情報 等
              <br />
              ...
              ・発行会社の個人情報保護の措置
              <br />
              各国における個人情報保護制度に関する情報については、個人情報保護委員会のホームページ（https://www.ppc.go.jp/）に、掲載されています。
              <br />
